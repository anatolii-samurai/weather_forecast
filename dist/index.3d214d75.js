...
window.addEventListener("load", function() {
    const lastCity = (0, _localStorageJs.getLastCity)();
    if (lastCity) {
        searchName.value = lastCity;
        addCityInput();
    }
});
const listLocation = (0, _localStorageJs.getLocationFromStorage)();
...
function render(listLocation) {
    ...
    for(let i = 0; i < listLocation.length; i++){
        ...
        closeList.addEventListener("click", (e)=>{
            ...
            (0, _localStorageJs.setterStorage)(listLocation);
            render(listLocation);
        });
...
function addCityInput(cityName) {
    ...
    f(url);
    searchName.value = "";
    (0, _localStorageJs.setLastCity)(cityName);
}
...
},{"./local-storage.js":"6Jflv"}]},["3smKr","bB7Pu"], "bB7Pu", "parcelRequire225c")
